...
### 🏆 MX Linux
Моя самая красивая, проработанная и гордая работа, выполненная в абсолютном стиле футуризма. Максимально технологичный интерфейс: кастомные круговые виджеты мониторинга ресурсов (память, температура процессора, датчики накопителей), неоновые элементы, прозрачные панели и футуристичный док. Настоящий интерфейс из научной фантастики, совмещающий невероятную визуальную глубину и полный контроль над системой.
